          ...
          <header className="border-b border-gray-800 bg-darker/80 backdrop-blur-md sticky top-0 z-40">
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
              <div className="flex items-center gap-3 cursor-pointer" onClick={fullExit}>
                <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-primary to-secondary flex items-center justify-center shadow-lg shadow-primary/20 shrink-0">
              ...
              {appState === AppState.VIEWING_GALLERY && (
                <Button onClick={handleStartScanClick} className="shadow-primary/25 px-3 sm:px-4">
          ...
          <main className="flex-1 w-full max-w-7xl mx-auto p-4 flex flex-col">
            ...
            {appState === AppState.VIEWING_GALLERY && (
              <div className="animate-fade-in-up pb-20">
                ...
                {/* BIG CTA CARD */}
                <div className="bg-gradient-to-r from-primary/20 to-purple-600/20 border border-primary/30 rounded-2xl p-6 mb-8 text-center relative overflow-hidden group cursor-pointer" onClick={handleStartScanClick}>
                  <div className="absolute inset-0 bg-primary/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  <div className="relative z-10 flex flex-col items-center gap-4">
                    <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center shadow-lg shadow-primary/40 animate-pulse-slow">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white mb-1">Find Your Photos</h2>
                      <p className="text-gray-300 max-w-sm mx-auto text-sm">
                        We found {allFiles.length} photos. Scan your face to instantly filter and download yours.
                      </p>
                    </div>
                    <Button className="mt-2 px-8 py-3 text-lg shadow-xl shadow-primary/20">
                      Start Face Scan
                    </Button>
                  </div>
                </div>
                ...
                <div className="mb-4 flex items-end justify-between px-2">
                  <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider">All Photos Preview</h3>
                </div>
